...
class Project_Home():
    ...
    def main_menu(self):
        ...
        #b1 = self.canvas.create_rectangle(175,500,275,475,fill='#20202e')
        #b2 = self.canvas.create_rectangle(300,500,400,475,fill='#20202e')
        #b3 = self.canvas.create_rectangle(425,500,525,475,fill='#20202e')
        #b4 = self.canvas.create_rectangle(550,500,650,475,fill='#20202e')
